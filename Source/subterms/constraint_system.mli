...
module Rule : sig
  ...
  val normalisation : 'a Set.t -> call_stack ->  ('a Set.t -> call_stack -> unit) -> unit
  ...
  val sat : 'a Set.t -> call_stack -> 'a continuation -> unit

  val sat_disequation : 'a Set.t -> call_stack -> 'a continuation -> unit

  val sat_formula : 'a Set.t -> call_stack -> 'a continuation -> unit

  val equality_constructor : 'a Set.t -> call_stack -> 'a continuation -> unit

  val equality : 'a Set.t -> call_stack -> 'a continuation -> unit

  val rewrite : 'a Set.t -> call_stack -> 'a continuation -> unit
