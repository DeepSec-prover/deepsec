...
TESTS = {
    ...
    'BAC_FR_plus_5': {'res': True, 'name': ' ', 'file': 'BAC_FR_plus_5.txt', 'cat': 12, 'det' : False},
    'BAC_FR_plus_6': {'res': True, 'name': ' ', 'file': 'BAC_FR_plus_6.txt', 'cat': 12, 'det' : False},
    'BAC_FR_plus_7': {'res': True, 'name': ' ', 'file': 'BAC_FR_plus_7.txt', 'cat': 12, 'det' : False},
